...
function getCard(show, cardProps) {
  return show ? <TimelineCard {...cardProps} /> : <div className="col-sm" />;
}

function TimelineItem({align, active, isLast, isFirst, release, ...cardProps}) {
  return (
    <div className="row no-gutters">
      ...
      <div className="col-sm-1 text-center flex-column d-none d-sm-flex">
        ...
        <h5 className="m-2">
          <span
            className={`badge badge-pill ${active && 'bg-active'} ${release &&
              'bg-eventol'} ${!active && !release && 'bg-light border'}`}
          >
            &nbsp;
          </span>
        </h5>
