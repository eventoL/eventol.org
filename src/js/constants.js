...
export const TIMELINE_DATA = [{
  ...
  text: 'First commit: [in github](https://github.com/eventoL/eventoL/commit/b8e2efb66bcebf2d44462f5b32c86256e5bc8a04)',
  align: 'left',
}, {
  date: '27/08/2015',
  title: 'Eventol v0.0.0',
  text: 'Release 2015: [in github](https://github.com/eventoL/eventoL/releases/tag/v0.0.0)',
  detail: CHANGELOGS['v0.0.0'],
  release: true,
}, {
  date: '25/02/2017',
  title: 'Eventol v0.1.0',
  text: 'Release 2016: [in github](https://github.com/eventoL/eventoL/releases/tag/v0.1.0)',
  align: 'left',
  ...
  text: 'Release 2017: [in github](https://github.com/eventoL/eventoL/releases/tag/v1.0.0)',
  detail: CHANGELOGS['v1.0.0'],
  release: true,
}, {
  date: '21/02/2018',
  title: 'New EventoL public instance',
  text: 'Flisol instance [https://eventol.flisol.org.ar](https://eventol.flisol.org.ar)',
  align: 'left',
  active: true,
}, {
  date: '05/05/2018',
  title: 'EventoL v2.0.0',
  text: 'First release of 2018: [in github](https://github.com/eventoL/eventoL/releases/tag/v2.0.0)',
  detail: CHANGELOGS['v2.0.0'],
  release: true,
}, {
  date: '08/05/2018',
  title: 'EventoL v2.0.1',
  text: 'Second release of 2018: [in github](https://github.com/eventoL/eventoL/releases/tag/v2.0.1)',
  align: 'left',
  ...
  date: '12/08/2018',
  title: 'New EventoL public instance',
  text: 'PyAr instance [https://eventos.python.org.ar](https://eventos.python.org.ar)',
  active: true,
}, {
  date: '03/02/2019',
  title: 'EventoL v2.1.0',
  text: 'Third release of 2018: [in github](https://github.com/eventoL/eventoL/releases/tag/v2.1.0)',
  align: 'left',
